...
export function Contacto() {
  return (
    <section id="contacto" className="snap-moment section-seam bg-surface/90 py-24 md:py-32">
      <div className="mx-auto max-w-7xl px-6">
        <div className="grid gap-14 md:grid-cols-12 md:gap-16">
          ...
          <div className="grid gap-4 sm:grid-cols-3 md:col-span-7 md:self-center">
            {canales.map((canal, i) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <div className="flex h-full flex-col gap-4 rounded-[1.75rem] bg-ink/5 p-1.5 ring-1 ring-ink/5 transition-transform duration-300 group-hover:-translate-y-1">
                      <div className="flex h-full flex-col gap-4 rounded-[1.4rem] bg-surface px-6 py-7 ring-1 ring-line">
                        <span className="flex h-11 w-11 items-center justify-center rounded-full bg-gold-pale/60 text-gold-deep">
                        ...
                        <div>
                          ...
                          <p className="mt-1 text-base font-medium text-ink">{canal.valor}</p>
                        </div>
                      </div>
                    </div>
                  </a>
